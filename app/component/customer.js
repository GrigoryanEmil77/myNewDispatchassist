      ...
      <div className="row custom mt-5 elements" >
        <div className="col-md-4 elements" data-aos="fade-right">
          <div className="card-body review-card-body">
            <img src={customer1picture ||null} alt="Customer" style={{
    WebkitUserDrag: "none",
    userDrag: "none",
    userSelect: "none",
        ...
        <div className="col-md-4 elements" data-aos="fade-right">
          <div className="card-body review-card-body">
            <img src={customer2picture ||null} alt="Customer"  style={{
    WebkitUserDrag: "none",
    userDrag: "none",
    userSelect: "none",
  }}className="review-image" />
        ...
        <div className="col-md-4 elements" data-aos="fade-right">
          <div className="card-body review-card-body">
            <img src={customer3picture ||null} alt="Customer" className="review-image"  style={{
    WebkitUserDrag: "none",
    userDrag: "none",
    userSelect: "none",
  }}/>
